...
exon as well as the count data from the sum of the other exons 
belonging to the same gene. This annotation, as well
...
We can access the full count data (both the counts per exon and
the sum of the other exons from the same gene) using

<<seeCounts>>=
head( counts(dxd), 7 )
@

We can also access only the count data from the exons (without
showing the sum of counts from the rest of the exons from the same gene)
by doing:

<<seeCounts2>>=
head( featureCounts(dxd), 7 )
@
...
@
%
\incfig{figure/fitdiagnostics}{.5\textwidth}{Fit Diagnostics.}{The initial per-exon dispersion estimates 
...
plotMA( dxr1, cex=0.8 )
@
\incfig{figure/MvsA}{.5\textwidth}{MA plot.}{
...
@
%
\incfig{figure/plot1}{\textwidth}{Fitted expression.}{
...
@
%
\incfig{figure/plot2}{\textwidth}{Transcripts.}{
...
@
%
\incfig{figure/plot3}{\textwidth}{Normalized counts.}{
...
@
%
\incfig{figure/plot4}{\textwidth}{Fitted splicing.}{
